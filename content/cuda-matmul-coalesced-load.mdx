...
<Figure
    src="/articles/cuda-deep-dive/coalesced-load.svg"
    alt="Comparison between coalesced global load and strided global load"
    width={1280}
    height={720}
    caption="Coalesced load 看的是一个 warp 里的地址形状：相邻 lane 访问相邻地址，硬件才更容易用少量 transaction 搬回数据。"
/>
