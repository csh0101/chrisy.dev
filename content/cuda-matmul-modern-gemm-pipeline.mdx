...
<Figure
    src="/articles/cuda-deep-dive/modern-gemm-pipeline.svg"
    alt="Modern GEMM pipeline overlaps global to shared transfer, shared layout, register fragments and MMA"
    width={1280}
    height={720}
    caption="现代 GEMM 的主线不是术语堆叠，而是把 global->shared 搬运、shared->register 读取、MMA 计算和下一轮预取错开重叠。"
/>
