...
<Figure
    src="/articles/cuda-deep-dive/tiling-data-reuse.svg"
    alt="A tile and B tile are loaded once and reused to produce a C tile"
    width={1280}
    height={720}
    caption="Tiling 的直觉：A_tile 和 B_tile 从 global memory 搬进来一次，然后在 shared memory 里被同一个 block 反复使用。"
/>
