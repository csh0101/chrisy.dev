...
<Figure
    src="/articles/cuda-deep-dive/vectorized-load-shared-layout.svg"
    alt="Vectorized global load writes data into an optimized shared memory layout"
    width={1280}
    height={720}
    caption="同一批数据有两种诉求：从 global memory 读取时要连续、对齐；写进 shared memory 后要方便后续 warp 和 register tile 读取。"
/>
